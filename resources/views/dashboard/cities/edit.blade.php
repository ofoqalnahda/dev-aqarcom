                                        ...
                                        <div class="row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <select name="area_id" id="" class="form-control">
                                                            ...
                                                            @foreach($areas as $area)
                                                                <option value="{{$area->id}}" {{$area->id == $city->area_id ? 'selected' :'' }}>{{$area->name}}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-12">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" id="first-name" class="form-control" name="ar[name]" value="{{$city->translate('ar')->name}}" />
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-12">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" id="first-name" class="form-control" name="en[name]" value="{{$city->translate('en')->name}}" />
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-12">
                                                <div class="form-group row">
                                                    <div class="col-sm-9">
                                                        <input type="hidden" id="lat" class="form-control" name="lat" value="{{$city->lat}}"  />
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-12">
                                                <div class="form-group row">
                                                    <div class="col-sm-9">
                                                        <input type="hidden" id="lang" class="form-control" name="lng" value="{{$city->lng}}"  />
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-12">
