            ...
            <div class="content-body">
                ...
                <section id="dashboard-ecommerce">
                    ...
                    <div class="row match-height">
                        @can('supportServices-create')
                            <div class="col-lg-12 col-12">
                                <div class="card card-company-table">
                                    <div class="card-body p-1 search-bar">
                                        <a href="{{ route('dashboard.supportServices.create') }}"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                ...
                                                                @can('supportServices-edit')
                                                                    <a href="{{ route('dashboard.supportServices.edit', $service->id) }}"
                                                                        class="btn-sm btn-info">@lang('edit')</a>
                                                                @endcan
                                                                @can('supportServices-destroy')
                                                                    <form
                                                                        action="{{ route('dashboard.supportServices.destroy', $service->id) }}"
                                                                        method="post">
                                                                        @csrf
                                                                        @method('delete')
                                                                        <button type="submit"
