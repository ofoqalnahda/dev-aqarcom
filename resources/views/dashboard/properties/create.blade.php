                    ...
                    <div class="row">
                        <div class="col-md-12 col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form class="form form-horizontal" action="{{route('dashboard.properties.store')}}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        <div class="row">
                                            <div class="col-12">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <select name="type" class="form-control " id="type-select">
                                                            <option value="">@lang('select_value')</option>
                                                            <option value="slider">@lang('range')</option>
                                                            <option value="multi">@lang('multi')</option>
                                                            <option value="switch">@lang('switch')</option>
                                                        </select>
                                                    </div>
                                                </div>
                                            </div>

                                            <div style="display: none" class="col-12 slider-input">
                                                <div class="form-group row">
                                                    <div class="col-sm-3 col-form-label">
                                            ...
                                            <div style="display: none" class="col-12 slider-input">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control" name="max_value" value="{{old('max_value')}}"  />
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-12">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="d-flex custom-control custom-control-primary custom-switch">
                                                        <input type="checkbox" class="custom-control-input" name="show_outside" id="customSwitch3" />
                                        ...
                                        <div style="display: none" class="card-body select-values">
