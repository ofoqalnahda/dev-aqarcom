                    ...
                    <div class="row">
                        <div class="col-md-12 col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form class="form form-horizontal" action="{{route('dashboard.admins.store')}}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        <div class="row">
                                            <div class="col-12">
                                            ...
                                            <div class="col-12">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="email" id="email-id" class="form-control" name="email" value="{{old('email')}}" />
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-12">
                                            ...
                                            <div class="col-sm-9">
                                                <select name="role_id"  class="form-control custom-select" id="roles">
