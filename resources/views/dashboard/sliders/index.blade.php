                        ...
                        <div class="col-lg-12 col-12">
                            <div class="card card-company-table">
                                <div class="card-body p-1 search-bar">
                                        <form class="search-form " method="post" action="{{route('dashboard.sliders.store')}}" enctype="multipart/form-data">
                                            @csrf
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                <img style="width:50px; height:50px;" class="img-rounded" src="{{$slider->image}}" alt="admin-image" />
                                                            </div>
                                                        </td>
                                                        <td>
                                                            @can('sliders-destroy')
