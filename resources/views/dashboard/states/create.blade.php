                    ...
                    <div class="row">
                        <div class="col-md-12 col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form class="form form-horizontal" action="{{route('dashboard.states.store')}}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" id="first-name" class="form-control" name="name_ar" value="{{old('name_ar')}}" />
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-12">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" id="first-name" class="form-control" name="name_en" value="{{old('name_en')}}"  />
                                                    </div>
                                                </div>
                                            </div>
