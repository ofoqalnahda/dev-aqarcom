...
<body style="font-family: 'Calibri' , sans-serif !important" class="vertical-layout vertical-menu-modern blank-page navbar-floating footer-static  " data-open="click" data-menu="vertical-menu-modern" data-col="blank-page">
<!-- BEGIN: Content-->
                    ...
                    <div class="card mb-0">
                        <div class="card-body">
                            <a href="javascript:void(0);" class="brand-logo">
                                <h2 class="brand-text text-primary ml-1">تسجيل الدخول</h2>
                            </a>
                            ...
                            <form class="auth-login-form mt-2" action="{{route('dashboard.login')}}" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="login-email" name="email" placeholder="ahmed@example.com" aria-describedby="login-email" tabindex="1" autofocus value="{{old('email')}}" />
                                    {{session('error')}}
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="custom-control custom-checkbox">
                                        <input class="custom-control-input" type="checkbox" name="remember" value="true" id="remember-me" tabindex="3" />
